export default function AdminPage() {
  const imageUrl =
    "https://lh3.googleusercontent.com/aida-public/AB6AXuBZ3kDCGxlZVefcZoXXpFqzACRWdbbqHforeDjZJ9Cw4fr92tuHql1ODClgOytuP_5KXV09YzRmImmQAtPvaOv2wjvGRjPnDLq6nkakytTx4SOmCpYJaYnMarI_nV1h_Xgw2dtL7vnNcG8UhiYVg3YXOeXGKygSMAAXMvis7L8kiDfwppDmmOXAXET49JJakTJVESh0BX_RlHsrmCPjyXq94aWHODLqCx_98kfY_mnkcowY7Z-4Gxjh4Sbg37cq2d_QJExE2ks8adHH";
  return (
        ...
        <div className="max-w-[1200px] mx-auto flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-background-light dark:bg-background-dark p-6 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm flex flex-col gap-3 group hover:border-primary/50 transition-colors">
              ...
              <div className="flex items-center gap-1 text-sm">
                <span className="text-[#0bda57] font-semibold bg-[#0bda57]/10 px-1.5 py-0.5 rounded text-xs flex items-center">
            ...
            <div className="bg-background-light dark:bg-background-dark p-6 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm flex flex-col gap-3 group hover:border-primary/50 transition-colors">
              ...
              <div className="flex items-center gap-1 text-sm">
                <span className="text-[#fa5f38] font-semibold bg-[#fa5f38]/10 px-1.5 py-0.5 rounded text-xs flex items-center">
                  <span className="material-symbols-outlined text-[14px] mr-0.5">
                    trending_down
                  </span>
                  1%
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 bg-background-light dark:bg-background-dark rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm p-6">
              <div className="flex justify-between items-center mb-6">
                ...
                <select className="bg-transparent text-sm font-medium text-primary border-none focus:ring-0 cursor-pointer">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 pb-6">
            <div className="bg-background-light dark:bg-background-dark rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
              ...
              <div className="p-0">
                <div className="flex items-center p-4 border-b border-gray-100 dark:border-gray-800 hover:bg-background-light dark:hover:bg-white/5 transition-colors">
                  <div
                    className="h-12 w-12 rounded-lg bg-cover bg-center mr-4 flex-shrink-0"
                ...
                <div className="flex items-center p-4 hover:bg-background-light dark:hover:bg-white/5 transition-colors">
                  <div
                    className="h-12 w-12 rounded-lg bg-cover bg-center mr-4 flex-shrink-0"
            ...
            <div className="bg-background-light dark:bg-background-dark rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
              ...
              <div className="p-0">
                ...
                <div className="grid grid-cols-12 px-4 py-3 items-center border-b border-gray-100 dark:border-gray-800 hover:bg-background-light dark:hover:bg-white/5 transition-colors">
                ...
                <div className="grid grid-cols-12 px-4 py-3 items-center hover:bg-background-light dark:hover:bg-white/5 transition-colors">
                  <div className="col-span-7 flex items-center gap-3">
                    <div
                      className="h-10 w-10 rounded-md bg-cover bg-center"
